...
import {PLATFORM} from 'src/theme/native-base-theme/variables/commonColor';
...
export default {
    ...
    // Footer
    footerHeight: 55,
    footerDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#C0121A',
    footerPaddingBottom: 0,

    // FooterTab
    tabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : '#000',
    ...
    tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#8f0007',

    // Header
    toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
    toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : 'rgba(192, 18, 26, 1)',
    ...
    toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : '#C0121A',
    ...
    listItemSelected: platform === PLATFORM.IOS ? '#007aff' : '#C0121A',
    ...
    radioSelectedColorAndroid: '#C0121A',
    ...
    // Segment
    segmentBackgroundColor: platform === PLATFORM.IOS ? '#F8F8F8' : '#C0121A',
    segmentActiveBackgroundColor:
        platform === PLATFORM.IOS ? '#007aff' : '#fff',
    segmentTextColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
    segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#C0121A',
    segmentBorderColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
    segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : '#C0121A',

    // Spinner
    defaultSpinnerColor: '#C0121A',
    inverseSpinnerColor: '#1A191B',

    // Tab
    tabBarDisabledTextColor: '#BDBDBD',
    tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#C0121A',
